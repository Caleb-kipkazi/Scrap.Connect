...
//     try {
//       const response = await axios.post('http://    192.168.1.119:5000/api/v1/center/signup/', {
  ...
  const onRegister = async () => { // Made async for API call
    ...
    try {
      const response = await axios.post(
        "http://192.168.1.119:5000/api/v1/center/signup/", // Correct API endpoint for Center Signup
        {

...
// NEW: Additional route from ROUTER 2 for getting all collector requests (with ROUTER 1's trailing slash)
router.get("/collector/requests/:collectorId/", getAllCollectorRequests);
...
// --- Payment Routes ---
router.post('/payment/send', paymentController.payHomeowner);

// FIX: Changed getHomeownerPayments to getPaymentsByHomeowner to match export in paymentController.js
router.get('/payments/user/:homeownerId/list/', paymentController.getPaymentsByHomeowner);

// Debugging logs - Check these outputs!
console.log("DEBUG: paymentController object:", paymentController);
console.log("DEBUG: paymentController.getPaymentsByCollector:", typeof paymentController.getPaymentsByCollector, paymentController.getPaymentsByCollector);
console.log("DEBUG: paymentController.getPaymentsByHomeowner:", typeof paymentController.getPaymentsByHomeowner, paymentController.getPaymentsByHomeowner);


router.get("/payments/collector/:collectorId/", paymentController.getPaymentsByCollector); // Line 287 (approx)
router.get("/payments/homeowner/:homeownerId/", paymentController.getPaymentsByHomeowner); // Line 288 (approx)
...
// NEW: Additional route for assignCollectorToRequest from ROUTER 2
router.post("/requests/assign/", assignCollectorToRequest);

// Kept from ROUTER 1's assignCollectorToRequest route
router.post('/request/assign/', assignCollectorToRequest);


// NEW: Additional route for getRequestByStatus from ROUTER 2
router.get("/requests/status/:status/", getRequestByStatus);
